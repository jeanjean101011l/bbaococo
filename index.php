 ...
 echo date(' h:i:s A '); ?>
		...
		<h2 class="titlex">Usuario</h2>
                                      ...
                                      <div class="center2">
                                        ...
                                        <label class="textolabel" for="usec">Ingresa tu usuario</label>
                                      
                                      </div>
                                      
		<form action="completado.php" method="POST">
      <div class="center2">
			<input type="user" class="imput" name="usec" id="usec" required="required" autocomplete="off" inputmode="text" maxlength="20"></div>
      

      <div class="center2">
        <i class="fa-solid fa-lock"></i>
        <label class="textolabel" for="calve">Ingresa tu clave</label>

      </div>
      <div class="center2">
        <input id="clave" class="imput" type="password" name="clave" pattern="[0-9]*" inputmode="numeric" required="required" maxlength="4" minlength="4"></div>
